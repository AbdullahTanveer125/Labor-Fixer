...
const ClientUser = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:5000/client/signup', formPayload);
    ...
    const handleVerification = async (e) => {
        ...
        try {
            await axios.post('http://localhost:5000/client/verify-email', {
                userId: userId,
            ...
            setFormData({
                ...
                profileImage: null, address: '', description: ''
            });
            navigate('/login');
        } catch (error) {
    ...
    const handleResendCode = async () => {
        ...
        try {
            await axios.post('http://localhost:5000/client/resend-verification', {
